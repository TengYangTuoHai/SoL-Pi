...
- Use Node.js 22.19 or newer and the tested Pi release `@earendil-works/pi-coding-agent@0.87.1`. Treat a different Pi version as a compatibility change and rerun the full suite before using it.
